...
// Oublex MP lobby card. GENERIC N-player (2–4) lobby ported from
// Yahdle — works as-is for any SQ game using the oublex_multiplayer.sql
...
// `oublex_players` array (the supabase-js embed key).
//
